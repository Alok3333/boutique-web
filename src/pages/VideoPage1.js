...
// // // // //       }
// // // // //     }
// // // // //   }, [currentIndex, selectedVoice, speechSupported, isPlaying]);
...
// // // //       cancelSpeech(); // Ensure speech is canceled before starting new speech
...
// // //   useEffect(() => {
// // //     // Speak when the video data changes
// // //     if (selectedVoice && videos[currentIndex].voicetext) {
...
//                 if (isPlaying) setProgress(playedSeconds);
//               }}
//               onEnded={handleNext} // Automatically go to next video when current ends
//             />
//           </Box>
//         );
//       case "text-image":
        ...
        return (
          <Box className={`${styles.videoContainer} ${contentClasses}`}>
            <ReactPlayer
              ...
              onEnded={handleNext} // Automatically go to next video when current ends
              onReady={() => {
                // Set progress when video is ready
                if (playerRef.current) {
                  setProgress(playerRef.current.getCurrentTime());
                }
              }}
